            ...
            var p = new OptionSet
                {
                    ...
                    {"teamcityUserId=", "Username to connect with (if in teamcity build use teamcity.auth.userId)", v => _configuration.TeamCityUserId = v},
                    {"teamcityPassword=", "Username to connect with (if in teamcity build use teamcity.auth.password)", v => _configuration.TeamCityPassword = v},
